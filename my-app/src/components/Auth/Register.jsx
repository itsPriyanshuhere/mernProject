        ...
        <VStack h={'full'} justifyContent='center' spacing={'16'}>
            ...
            <form style={{width :"100%"}}>
                ...
                <Box >
                    ...
                    <Input required id='name' value={name} onChange={e=>setName(e.target.value)} placeholder='NimishDureja' type={'text'} focusBorderColor='yellow.500' />
                </Box>
                <Box my={'2'}>
                ...
                <Box>
                    ...
                    <Input required id='password' value={password} onChange={e=>setPassword(e.target.value)} placeholder='2ed@2%^3' type={'password'} focusBorderColor='yellow.500' />
                </Box>
                <Box my={'2'}>
                    <FormLabel htmlFor='chooseAvtaar' children="Choose Avtaar" />
                    <Input accept='image/*' required id='chooseAvtaar' type={'file'} focusBorderColor='yellow.500' css={fileUploadStyle} onChange={changeImageHandler} />
                </Box>
